...
\usepackage{pmmeta}
\pmcanonicalname{JacobiDeterminant}
\pmcreated{2013-03-22 12:07:08}
\pmmodified{2013-03-22 12:07:08}
\pmowner{akrowne}{2}
\pmmodifier{akrowne}{2}
\pmtitle{Jacobi determinant}
\pmrecord{8}{31268}
\pmprivacy{1}
\pmauthor{akrowne}{2}
\pmtype{Definition}
...
\pmsynonym{Jacobian}{JacobiDeterminant}
