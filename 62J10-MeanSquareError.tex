...
\usepackage{pmmeta}
\pmcanonicalname{MeanSquareError}
\pmcreated{2013-03-22 12:07:42}
\pmmodified{2013-03-22 12:07:42}
\pmowner{CWoo}{3771}
\pmmodifier{CWoo}{3771}
\pmtitle{mean square error}
\pmrecord{11}{31289}
\pmprivacy{1}
\pmauthor{CWoo}{3771}
\pmtype{Definition}
...
\pmsynonym{MSE}{MeanSquareError}
\pmsynonym{MVUE}{MeanSquareError}
\pmsynonym{UMVU}{MeanSquareError}
\pmsynonym{UMVUE}{MeanSquareError}
\pmsynonym{uniformly minimum variance unbiased}{MeanSquareError}
\pmrelated{MeanSquareDeviation}
\pmdefines{minimum variance unbiased estimator}
\pmdefines{rms error}
\pmdefines{root-mean-square}
\pmdefines{root mean square}
\pmdefines{rms}
